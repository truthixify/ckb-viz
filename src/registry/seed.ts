...
export const SCRIPT_META: Record<KnownScriptId, ScriptMeta> = {
  ...
  usdi: {
    ...
    shortName: 'USDI',
    category: 'type',
    meaning: 'USDI stablecoin — an xUDT-compatible fungible token with its own type script.',
  },
  rusd: {
    name: 'RUSD (Stable++)',
    shortName: 'RUSD',
    category: 'type',
    meaning: 'RUSD stablecoin from Stable++ — an xUDT-compatible fungible token.',
  },
  ccbtc: {
    name: 'ccBTC',
    shortName: 'ccBTC',
    category: 'type',
    meaning: 'ccBTC — a 1:1 Bitcoin-backed xUDT-compatible token.',
  },
  wckb: {
    name: 'Wrapped CKB',
    shortName: 'wCKB',
    category: 'type',
    meaning: 'Wrapped CKB — an xUDT-compatible representation of CKB as a token.',
  },
  cheque: {
    name: 'Cheque',
    shortName: 'Cheque',
    category: 'lock',
    meaning: 'A temporary lock: the receiver can claim, or the sender can withdraw after a timeout.',
  },
  btcTimeLock: {
    name: 'RGB++ BTC time lock',
    shortName: 'BTC time',
    category: 'lock',
    meaning: 'An RGB++ lock that releases after a set number of Bitcoin confirmations.',
  },
  nostrLock: {
    name: 'Nostr lock',
    shortName: 'Nostr',
    category: 'lock',
    meaning: 'Unlocks with a Nostr (schnorr) key — the ckb-nostr-binding lock.',
  },
  pwLock: {
    name: 'PW-Lock',
    shortName: 'PW-Lock',
    category: 'lock',
    meaning: 'An Ethereum / EVM-wallet signature lock.',
  },
  uniqueType: {
    name: 'Unique cell',
    shortName: 'Unique',
    category: 'type',
    meaning: "A token-info cell holding a UDT's decimals, name, and symbol.",
  },
  cota: {
    name: 'CoTA',
    shortName: 'CoTA',
    category: 'type',
    meaning: 'Compact Token Aggregator — aggregated NFT / token state.',
  },
  didCkb: {
    name: 'did:ckb',
    shortName: 'did:ckb',
    category: 'type',
    meaning: 'An on-chain decentralized identity (did:ckb), built on Spore.',
  },
}
